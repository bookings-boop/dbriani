...
STYLE_DIRECTIVE = (
    ...
    "4. SHORT & SPACED (operator's #1 format complaint) — keep it BRIEF and cut "
    "filler ('thanks for reaching out', 'welcome', 'one of our favourite', "
    "'sounds perfect for it'). Put each distinct idea on its OWN short line or "
    "its own message bubble (greeting / answer / price / question), using line "
    "breaks for readability. This OVERRIDES any 'default to one message' "
    "guidance: 2-3 short, spaced messages beat one long paragraph. Never a "
